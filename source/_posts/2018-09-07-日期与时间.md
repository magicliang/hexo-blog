...
TIMESTAMP 类型在被存储时，会被转往 UTC 时区（此处 UTC 被当做时区来用），在取值的时候，又会被取成当前时区的时间。
...
具体内容见[《Conversion Between Date and Time Types》][5]。
  ...
  [5]: https://dev.mysql.com/doc/refman/8.0/en/date-and-time-type-conversion.html