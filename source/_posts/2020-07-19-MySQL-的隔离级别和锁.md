...
## 避免死锁有哪些方法
 ...
 - 如果有得选，必须先进行 select，至少确认一个 id 是存在的，再调用 update 或者 delete，避免触发大范围的全表锁定。如果不这样做，[可能触发 IX 兼容但 X LOCK 和 IX 不兼容的死锁问题][7]。
...
死锁情况可通过[show engine innodb status查看][8]。
  ...
  [7]: https://www.jianshu.com/p/f8495015dace
  [8]: https://blog.csdn.net/dhfzhishi/article/details/81272360