...
如果没有重试和超时，则任一 participant 节点失灵，都可能导致已经做了 pre-commit 的其他 participant 用久 hang 住，因为 coordinator 会收集不到足够的签名（vote/ballot）而 hang 住。
...
![saga 模型](https://ws1.sinaimg.cn/large/66dd581fly1fmpkhiolmtj20hs07udfz.jpg)
